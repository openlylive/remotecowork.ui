...
Janus.init = function (options) {
  ...
  if (Janus.initDone === true) {
    ...
    if (options.debug === true || options.debug === 'all') {
      ...
      Janus.trace = console.warn.bind(console)
      Janus.debug = console.warn.bind(console)
      Janus.vdebug = console.warn.bind(console)
      Janus.log = console.warn.bind(console)
...
function Janus (gatewayCallbacks) {
  this.isExtensionEnabled = function() {
  ...
  if (iceServers === undefined || iceServers === null) { iceServers = [{urls: 'stun:stun1.l.google.com:19302'}] }
  ...
  function streamsDone (handleId, jsep, media, callbacks, stream) {
    ...
    if (config.myStream) { console.log("new local stream") 
